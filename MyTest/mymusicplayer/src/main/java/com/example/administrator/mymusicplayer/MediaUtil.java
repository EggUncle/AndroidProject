...
//    }
    ...
    */
    ...
    public static Bitmap getAlbumImage(int album_id,Context context){
        Bitmap bm = null;
        String albumArt = getAlbumArt(album_id,context);
        if(albumArt==null){
            return BitmapFactory.decodeResource(Resources.getSystem(),R.drawable.icon_song);
        }else{
...
//        if(small){  //返回小图片
//            return BitmapFactory.decodeStream(context.getResources().openRawResource(R.drawable.icon_song), null, opts);
//        }
//        return BitmapFactory.decodeStream(context.getResources().openRawResource(R.drawable.icon_song), null, opts);
//    }
//
